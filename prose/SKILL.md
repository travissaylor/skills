...
- **End the sentence where the thought ends.** Periods and commas separate thoughts, and a new thought gets a new sentence (this is what em dashes were doing).
...
- **Name the real thing**: "the retry queue", not "the flywheel", and "the base image", not "the substrate". The concrete noun for the actual mechanism.
...
The three deep passes defer to this skill in their descriptions, so don't load them ahead of it. This skill is the entry point for prose, and it routes onward.
